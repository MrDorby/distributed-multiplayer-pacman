...
public class MongoDBConstants {
    ...
    private static final String LT = "mongodb://admin:password@longdb-mongo-0.longdb-mongo-svc.longdb.svc.cluster.local:27017,longdb-mongo-1.longdb-mongo-svc.longdb.svc.cluster.local:27017/statsDB?authSource=admin&replicaSet=longdb-mongo";
    private static final String ST = "mongodb://admin:password@shortdb-mongo-0.shortdb-mongo-svc.shortdb.svc.cluster.local:27017,shortdb-mongo-1.shortdb-mongo-svc.shortdb.svc.cluster.local:27017/shortDB?authSource=admin&replicaSet=shortdb-mongo";
